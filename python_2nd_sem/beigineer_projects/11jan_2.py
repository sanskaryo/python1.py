...
while True:
    print("====Shopping Inventory Management System====")
    print("1. Add Item")
    print("2. View Inventoty")
    print("3. Update Item")
    print("4. REmove Item")
    print("5. Search Item")
    ...
    if choice == 1:
            Name = int(input("Enter Employee Id: "))
            Price = input("Enter name of Employee")
            Quantity = int(input("Enter the age of employee"))
            Category = input("Enter the Gender")
            Database.append([Name,Price,Quantity,Category])
